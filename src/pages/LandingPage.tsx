    ...
    <div className="flex min-h-svh flex-col bg-background selection:bg-accent/30 selection:text-accent">
      ...
      <main className="flex-1 pt-16">
        ...
        <section className="relative overflow-hidden px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          ...
          <div className="absolute top-0 left-1/2 -z-10 -translate-x-1/2 opacity-20 blur-3xl">
          ...
          >
            ...
            <motion.h1
              variants={itemVariants}
              className="mb-8 font-heading text-6xl font-bold tracking-tight sm:text-8xl"
            >
            ...
            >
              Task Buddy is the calm in the middle of the storm. A simple,
              elegant, and powerful tool designed to help you stay focused on
              what truly matters.
            </motion.p>
            <motion.div
              variants={itemVariants}
            ...
            >
              <Link to="/register">
                <Button
                  size="lg"
                  className="h-14 rounded-full px-10 text-lg shadow-xl shadow-primary/20 transition-all hover:scale-105 active:scale-95"
                >
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 gap-2 rounded-full border-foreground/10 px-10 text-lg shadow-none backdrop-blur-sm hover:bg-foreground/5"
                onClick={scrollToPwa}
              >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-20 text-center">
              ...
              <p className="mx-auto max-w-2xl text-muted-foreground">
                Focus on your goals while we handle the complexity of
                organization.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Zero lag, real-time sync across all your devices instantly.",
                },
                {
                  icon: Layout,
                ...
                >
                  <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
                    "Task Buddy has completely changed how I manage my freelance
                    projects. It's not just a tool, it's a productivity
                    companion that feels premium and personal."
                  </p>
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-gradient-to-tr from-accent to-purple-400" />
                    <div>
                      <p className="font-bold">Harlson Gardose</p>
              ...
              <div className="relative flex-1">
                ...
                >
                  <div className="space-y-4 pt-8">
                    <div className="flex aspect-square items-center justify-center rounded-3xl border bg-secondary/50 p-4">
                      <Star className="h-12 w-12 text-accent" />
                    </div>
                    <div className="flex aspect-video flex-col justify-end rounded-3xl bg-primary p-6 text-primary-foreground">
                      <p className="text-2xl font-bold">50k+</p>
                      <p className="text-sm opacity-80">Active Buddies</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex aspect-[3/4] flex-col justify-end rounded-3xl bg-accent p-6 text-accent-foreground">
                      <p className="text-2xl font-bold tracking-tight">
                        Focus Mode
                      </p>
                      <p className="text-sm opacity-80">Distraction free</p>
                    </div>
                    <div className="aspect-square rounded-3xl border bg-secondary/50" />
                  </div>
                </motion.div>
              </div>
            </div>
        ...
        <section id="pwa-install" className="bg-background py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-[3rem] border bg-secondary/30 p-8 md:p-16">
              <div className="flex flex-col items-center gap-12 lg:flex-row">
                <div className="flex-1 text-center lg:text-left">
                  <h2 className="mb-6 font-heading text-4xl font-bold sm:text-5xl">
                    Experience Task Buddy{" "}
                    <span className="text-accent">Anywhere</span>
                  </h2>
                  <p className="mb-8 max-w-xl text-lg leading-relaxed text-muted-foreground">
                    Install Task Buddy as a desktop or mobile app. Enjoy faster
                    load times, offline access, and a distraction-free
                    environment tailored for high-performance work.
                  </p>
                ...
                <div className="flex flex-1 justify-center">
                  <div className="relative flex aspect-square w-full max-w-md items-center justify-center overflow-hidden rounded-[2.5rem] border-2 border-dashed border-primary/20 bg-gradient-to-tr from-primary/10 to-accent/10">
                    <Download className="absolute h-32 w-32 animate-pulse text-primary/20" />
                    <motion.div
                      initial={{ y: 20, opacity: 0 }}
                      whileInView={{ y: 0, opacity: 1 }}
                      className="relative z-10 rounded-3xl border bg-background p-6 shadow-2xl"
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="h-2 w-24 rounded-full bg-secondary opacity-50" />
                      </div>
                    </motion.div>
                  </div>
                </div>
        ...
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="mb-6 font-heading text-4xl font-bold sm:text-6xl">
            ...
            <Link to="/register">
              <Button
                size="lg"
                className="h-14 rounded-full bg-background px-10 text-lg text-primary transition-all hover:scale-105 hover:bg-secondary active:scale-95"
              >
                Join Task Buddy Now
              </Button>
            </Link>
      ...
      <footer className="border-t bg-secondary/20 py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-4 sm:px-6 md:flex-row lg:px-8">
          ...
          <p className="text-sm text-muted-foreground">
            © 2026 Task Buddy Inc. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a
              href="https://twitter.com/taskbuddy"
              target="_blank"
            ...
            <a
              href="https://github.com/taskbuddy"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary"
            >
