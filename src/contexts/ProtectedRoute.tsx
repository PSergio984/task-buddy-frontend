  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/5 blur-[80px]" />
      </div>
      ...
      >
        ...
        <div className="space-y-4 text-center">
          <h2 className="font-heading text-2xl font-black tracking-tighter text-foreground uppercase">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-[10px] font-black tracking-[0.2em] text-muted-foreground/60 uppercase italic">
              Syncing...
            </p>
          </div>
        </div>
