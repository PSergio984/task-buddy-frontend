...
## Corpus Check
- 83 files · ~123,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 869 nodes · 1355 edges · 76 communities (73 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c96e378e`
...
2. `cn()` - 31 edges
3. `useToast()` - 22 edges
4. `Task-Buddy Frontend` - 15 edges
5. `sanitizePassword()` - 13 edges
6. `TasksPage()` - 13 edges
7. `Task` - 11 edges
8. `Task-Buddy API Integration Guide` - 11 edges
9. `useTasks()` - 11 edges
10. `Core Sections (Required)` - 10 edges
...
- `handleSubmit()` --calls--> `sanitizeEmail()`  [EXTRACTED]
  src/components/auth/RegisterForm.tsx → src/lib/auth.ts
...
Cohesion: 0.06
Nodes (67): Dashboard(), NewTaskModal(), { 
    activeSidebarFilter, 
    setActiveSidebarFilter,
    activeTagId,
    setActiveTagId 
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, { groups } (+59 more)

### Community 1 - "Core UI Components"
Cohesion: 0.04
Nodes (37): attachTag, createSubtask, createTag, createTask, { data: allTags = [] }, { data: projects = [] }, [deleteSnapshot, setDeleteSnapshot], deleteSubtask (+29 more)
...
Cohesion: 0.1
Nodes (17): AuditEntry, AuditTrailProps, controller, [currentLimit, setCurrentLimit], [error, setError], EXCLUDED_ACTIONS, fetchAuditLog, filteredLogs (+9 more)

### Community 6 - "Theme Utilities"
Cohesion: 0.11
Nodes (20): [confirmPassword, setConfirmPassword], confirmPasswordError, [email, setEmail], emailError, handleSubmit(), navigate, [password, setPassword], passwordError (+12 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.11
Nodes (15): [category, setCategory], { data: groups = [] }, { data: projects = [] }, [description, setDescription], [dueDate, setDueDate], [groupId, setGroupId], { groups }, NewTaskModalProps (+7 more)
...
Cohesion: 0.11
Nodes (17): [activeTab, setActiveTab], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask (+9 more)
...
Cohesion: 0.12
Nodes (16): [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], [isInitialized, setIsInitialized], [isUpdatingPassword, setIsUpdatingPassword], [isUpdatingUsername, setIsUpdatingUsername], met, navigate, [newPassword, setNewPassword] (+8 more)

### Community 14 - "Build & Vite Configuration"
Cohesion: 0.16
Nodes (14): useAttachTag(), useCreateSubtask(), useCreateTag(), useDeleteSubtask(), useDeleteTask(), useDetachTag(), useUpdateSubtask(), Subtask (+6 more)
...
Cohesion: 0.17
Nodes (8): [color, setColor], COLORS, createProject, CreateProjectModalProps, [name, setName], { toast }, useCreateProject(), projectsApi
...
Cohesion: 0.17
Nodes (11): TaskPriority, {
    data: task,
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate, queryClient, { toast } (+3 more)

### Community 22 - "Community 22"
Cohesion: 0.17
Nodes (10): api, Group, isLogoutRequest, Project, statsApi, Tag, TagDistribution, tagsApi (+2 more)
...
Cohesion: 0.22
Nodes (8): SystemOverview(), StatsOverview, StatsOverview, Card, CardDescription, CardFooter, CardHeader, Skeleton()

### Community 26 - "Community 26"
Cohesion: 0.2
Nodes (7): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, Task, CardContent, DropdownMenu()
...
## Knowledge Gaps
- **489 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `EXCLUDED_ACTIONS`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]` (+484 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Data Models & Entities`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Project Documentation`, `Community 16`, `Community 19`, `Community 20`, `Community 22`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `Theme Utilities`, `API Documentation & Integration`, `Data Models & Entities`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Community 16`, `Community 19`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `Playwright Testing Config` to `Authentication & Authorization`, `Core UI Components`, `Community 64`, `Audit & Activity Logging`, `Community 58`, `State Management & Actions`, `Testing & Validation`, `Data Models & Entities`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 59`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `AuditEntry`, `AuditTrailProps`, `EXCLUDED_ACTIONS` to the rest of the system?**
