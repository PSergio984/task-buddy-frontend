# Graph Report - task-buddy-frontend  (2026-05-13)

## Corpus Check
- 117 files · ~139,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1167 nodes · 1869 edges · 100 communities (94 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `77e5cd0a`
...
Cohesion: 0.07
Nodes (60): [activeTab, setActiveTab], Dashboard(), DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete (+52 more)
...
Cohesion: 0.06
Nodes (34): markAllRead, { notifications, unreadCount }, useMarkAllRead(), useMarkRead(), useRegisterPush(), useVapidKey(), notificationsApi, [confirmPassword, setConfirmPassword] (+26 more)
...
Cohesion: 0.07
Nodes (29): handleSubmit(), handleSubmit(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete(), Action (+21 more)
...
Nodes (23): { 
    ...
    setSelectedProjects,
    setSelectedTags
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, deleteTag, [editingTag, setEditingTag] (+15 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.22
Nodes (21): TaskDetailDrawer(), useProjects(), useTags(), useTaskDrawerState(), UseTaskDrawerStateProps, useAttachTag(), useCreateSubtask(), useCreateTag() (+13 more)
...
Cohesion: 0.13
Nodes (15): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, [color, setColor], createTag, CreateTagModalProps, [icon, setIcon], [name, setName] (+7 more)
...
Cohesion: 0.16
Nodes (8): cn(), result, GripHandle, GripHandleProps, SortableSidebarItemProps, InputProps, labelVariants, TextareaProps

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (15): TaskPriority, {
    data: task,
    isLoading,
    error,
...
Cohesion: 0.14
Nodes (12): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, SettingsContext, SettingsContextType, SettingsProvider(), { result } (+4 more)
...
Cohesion: 0.14
Nodes (12): [color, setColor], COLORS, createProject, CreateProjectModalProps, [icon, setIcon], [name, setName], { toast }, updateProject (+4 more)
...
Cohesion: 0.24
Nodes (11): AuthContext, AuthContextType, AuthUser, BackendErrorDetail, extractAccessToken(), formatFirstBackendError(), getAuthErrorMessage(), normalizeAuthUser() (+3 more)
...
Cohesion: 0.17
Nodes (7): [inputValue, setInputValue], [isOpen, setIsOpen], [prevValue, setPrevValue], suggestions, { timeFormat }, TimePicker(), TimePickerProps
...
Cohesion: 0.22
Nodes (7): FilterContext, FilterContextType, FilterProvider(), useFilters(), { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId }, MobileNavProps, tabs
...
Cohesion: 0.22
Nodes (8): Group, isLogoutRequest, statsApi, subtasksApi, TagDistribution, TaskCreateData, tasksApi, TaskStats
...
Cohesion: 0.29
Nodes (7): handleClick(), iconMap, markRead, navigate, NotificationItemProps, Notification, NotificationType
...
Cohesion: 0.38
Nodes (7): RegisterForm(), sanitizePassword(), validateEmail(), validatePassword(), validatePasswordConfirmation(), validateUsername(), handleUpdatePassword()

### Community 69 - "Community 69"
Cohesion: 0.29
Nodes (6): mockProjects, mockTags, projectA, projectB, tagA, tagB
...
Cohesion: 0.47
Nodes (3): DeleteConfirmationModalProps, AlertDialog(), AlertDialogCancel()
...
Cohesion: 0.4
Nodes (4): Subtask, Task, SubtaskSection(), SubtaskSectionProps
...
- **Why does `cn()` connect `Project Documentation` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Tailwind CSS Styling`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 31`, `Community 32`, `Community 35`, `Community 65`, `Community 67`, `Community 73`, `Community 78`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Authentication & Authorization` to `User Navigation & Theme`, `Audit & Activity Logging`, `Community 68`, `Theme Utilities`, `Community 71`, `Testing & Validation`, `Linting Configuration`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Community 21`, `Community 23`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Community 36`, `Theme Utilities`, `Testing & Validation`, `Community 68`, `Linting Configuration`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Community 16`, `Community 21`, `Community 23`, `Community 26`?**
