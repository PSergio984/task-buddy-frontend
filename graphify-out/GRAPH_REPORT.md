...
## Corpus Check
- 70 files · ~115,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 682 nodes · 1015 edges · 61 communities (60 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1adbba7`
...
7. `useTasks()` - 11 edges
8. `Core Sections (Required)` - 10 edges
9. `Dashboard()` - 10 edges
10. `MainLayout()` - 9 edges
...
Cohesion: 0.07
Nodes (58): Dashboard(), NewTaskModal(), { 
    activeSidebarFilter, 
    setActiveSidebarFilter,
    activeTagId,
    setActiveTagId 
  }, categories, { data: groups = [] }, { data: tags = [] }, { groups }, handleLogout() (+50 more)

### Community 1 - "Core UI Components"
Cohesion: 0.07
Nodes (37): DashboardProps, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask, { logout }, { mutateAsync: deleteSubtask } (+29 more)
...
Cohesion: 0.09
Nodes (15): [category, setCategory], { data: groups = [] }, [description, setDescription], [dueDate, setDueDate], [groupId, setGroupId], { groups }, NewTaskModalProps, [priority, setPriority] (+7 more)
...
Cohesion: 0.14
Nodes (12): AuditEntry, AuditTrailProps, controller, [currentLimit, setCurrentLimit], [error, setError], filteredLogs, [loading, setLoading], [logs, setLogs] (+4 more)
...
Cohesion: 0.18
Nodes (10): categoryConfig, priorityConfig, TaskCardProps, Card, CardContent, CardDescription, CardFooter, CardHeader (+2 more)
...
Cohesion: 0.29
Nodes (3): cn(), InputProps, labelVariants
...
## Knowledge Gaps
- **377 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+372 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Data Models & Entities`, `Linting Configuration`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `Linting Configuration`, `Build & Vite Configuration`, `Community 19`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Data Models & Entities`?**
