...
## Corpus Check
- 90 files · ~125,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 934 nodes · 1525 edges · 79 communities (74 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af5eeeee`
...
Cohesion: 0.04
Nodes (43): attachTag, createSubtask, createTag, createTask, { data: allTags = [] }, { data: fetchedTask }, { data: projects = [] }, [deleteSnapshot, setDeleteSnapshot] (+35 more)

### Community 2 - "User Navigation & Theme"
Cohesion: 0.06
Nodes (36): [color, setColor], COLORS, createProject, CreateProjectModalProps, handleSubmit(), [name, setName], { toast }, handleAddSubtask() (+28 more)

### Community 3 - "Audit & Activity Logging"
Cohesion: 0.06
Nodes (29): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, { 
    activeSidebarFilter, 
...
Cohesion: 0.12
Nodes (17): Group, isLogoutRequest, Project, statsApi, StatsOverview, Subtask, subtasksApi, Tag (+9 more)
...
Cohesion: 0.29
Nodes (16): TaskDetailDrawer(), useProjects(), useTags(), useTaskDrawerState(), UseTaskDrawerStateProps, useAttachTag(), useCreateSubtask(), useCreateTag() (+8 more)

### Community 11 - "Linting Configuration"
Cohesion: 0.11
Nodes (17): [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], [isInitialized, setIsInitialized], [isUpdatingPassword, setIsUpdatingPassword], [isUpdatingUsername, setIsUpdatingUsername], { logout }, met, navigate (+9 more)
...
Cohesion: 0.15
Nodes (12): TaskPriority, [hours, minutes], MetaSidebar(), MetaSidebarProps, newDate, PRIORITY_STYLES, selectedProject, SelectScrollDownButton (+4 more)

### Community 17 - "Community 17"
Cohesion: 0.17
Nodes (10): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, LayoutContext, PRIORITY_ORDER, SORT_LABELS, SortMode (+2 more)

### Community 18 - "Community 18"
Cohesion: 0.23
Nodes (5): cn(), result, InputProps, labelVariants, TextareaProps
...
Cohesion: 0.17
Nodes (11): bold(), createdName, fieldChanges, getAuditIcon(), handleTaskUpdate(), IconConfig, name, parentMatch (+3 more)
...
Cohesion: 0.5
Nodes (3): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `User Navigation & Theme`, `Community 66`, `Task Management Forms`, `Audit & Activity Logging`, `API Documentation & Integration`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Community 17`, `Community 54`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `Linting Configuration`, `Build & Vite Configuration`, `Project Documentation`, `Community 16`, `Community 17`, `Community 19`, `Community 59`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `API Documentation & Integration`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Build & Vite Configuration`, `Community 17`, `Community 24`?**
