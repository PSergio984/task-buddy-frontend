# Graph Report - task-buddy-frontend  (2026-05-17)

## Corpus Check
- 149 files · ~157,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1666 nodes · 2598 edges · 135 communities (129 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11989669`
...
Cohesion: 0.05
Nodes (70): PRESET_COLORS, Sidebar(), TaskDetailDrawer(), TopNav(), useToast(), CreateProjectMutation, useProjectManagement(), UseProjectManagementReturn (+62 more)

### Community 1 - "Core UI Components"
Cohesion: 0.05
Nodes (71): { activeStatus, setActiveStatus }, [activeTab, setActiveTab], [confirmData, setConfirmData], Dashboard(), DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask (+63 more)
...
Cohesion: 0.13
Nodes (16): ColorIconPickerProps, cn(), result, SidebarBrandingProps, GripHandle, GripHandleProps, SidebarItemActions(), ProjectsSectionProps (+8 more)
...
Cohesion: 0.08
Nodes (23): PRESET_ICONS, [color, setColor], COLORS, createProject, CreateProjectModalProps, handleSubmit(), [icon, setIcon], [lastOpen, setLastOpen] (+15 more)
...
Nodes (26): { 
    ...
    setActiveStatus, 
    activeTagId,
  }, [confirmData, setConfirmData], { data: projects = [] }, { data: tags = [] }, { data: tasks = [], isLoading: loadingTasks, refetch: refreshTasks }, handleConfirmAction(), { handleEditTask }, handleToggleComplete() (+18 more)
...
Cohesion: 0.08
Nodes (25): [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], { data: vapidData }, { data: vapidData, isLoading: isLoadingVapid }, handleTogglePush(), [isInitialized, setIsInitialized], [isRegistering, setIsRegistering], [isUpdatingPassword, setIsUpdatingPassword] (+17 more)
...
Cohesion: 0.14
Nodes (16): markAllRead, { notifications, unreadCount }, handleClick(), iconMap, markRead, navigate, NotificationItemProps, NotificationWatcher() (+8 more)
...
Cohesion: 0.16
Nodes (9): LogoutDialogProps, useTheme(), ThemeToggle(), TopNavProps, buttonVariants, extraProps, isDisabled, Calendar() (+1 more)
...
Cohesion: 0.16
Nodes (8): SidebarItemActionsProps, onDelete, onEdit, parentClick, user, SortMode, TasksHeaderProps, DropdownMenu()

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (10): FilterContext, FilterContextType, FilterProvider(), useFilters(), PRIORITY_ORDER, SortMode, useTaskFilters(), { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId } (+2 more)
...
Cohesion: 0.18
Nodes (11): [email, setEmail], emailError, handleSubmit(), { login, loading }, { login, loading, error }, navigate, [password, setPassword], passwordError (+3 more)

### Community 37 - "Community 37"
Cohesion: 0.26
Nodes (12): handleSubmit(), navigate, normalizeText(), sanitizeEmail(), sanitizePassword(), sanitizeUsername(), validatePassword(), getErrorMessage() (+4 more)
...
Cohesion: 0.18
Nodes (11): handleConfirmAction(), handleConfirmDelete(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete(), genId() (+3 more)
...
## Knowledge Gaps
- **941 isolated node(s):** `LoginPage`, `RegisterPage`, `LandingPage`, `ForgotPasswordPage`, `ProfilePage` (+936 more)
...
- **Why does `cn()` connect `State Management & Actions` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 32`, `Community 102`, `Community 114`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Community 36`, `Testing & Validation`, `API Documentation & Integration`, `Data Models & Entities`, `Linting Configuration`, `Community 44`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Core UI Components` to `Authentication & Authorization`, `Audit & Activity Logging`, `Community 36`, `Task Management Forms`, `Community 40`, `Community 105`, `Data Models & Entities`, `API Documentation & Integration`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 31`?**
