...
## Corpus Check
- 78 files · ~118,796 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 740 nodes · 1166 edges · 63 communities (62 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31265d29`
...
Cohesion: 0.07
Nodes (69): [activeTab, setActiveTab], Dashboard(), DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete (+61 more)

### Community 1 - "Core UI Components"
Cohesion: 0.05
Nodes (37): [color, setColor], COLORS, createProject, CreateProjectModalProps, [name, setName], { toast }, LogoutDialogProps, [category, setCategory] (+29 more)

### Community 2 - "User Navigation & Theme"
Cohesion: 0.06
Nodes (30): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, { 
    activeSidebarFilter, 
...
Cohesion: 0.13
Nodes (13): AuditEntry, AuditTrailProps, controller, [currentLimit, setCurrentLimit], [error, setError], fetchAuditLog, filteredLogs, [loading, setLoading] (+5 more)

### Community 11 - "Linting Configuration"
Cohesion: 0.14
Nodes (13): api, Group, isLogoutRequest, Project, statsApi, StatsOverview, Subtask, subtasksApi (+5 more)
...
## Knowledge Gaps
- **407 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+402 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `State Management & Actions`, `Theme Utilities`, `Main Application Shell`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Project Documentation`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Main Application Shell`, `Project Documentation`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `cn()` connect `Core UI Components` to `Authentication & Authorization`, `User Navigation & Theme`, `Task Management Forms`, `API Documentation & Integration`, `Main Application Shell`, `Data Models & Entities`, `Community 47`, `Community 19`?**
