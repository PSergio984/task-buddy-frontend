# Graph Report - task-buddy-frontend  (2026-05-16)

## Corpus Check
- 171 files · ~176,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1584 nodes · 2495 edges · 137 communities (133 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e196219d`
...
Cohesion: 0.04
Nodes (47): attachTag, createSubtask, createTag, createTask, { data: allTags = [] }, { data: fetchedTask }, { data: projects = [] }, [deleteSnapshot, setDeleteSnapshot] (+39 more)

### Community 1 - "Core UI Components"
Cohesion: 0.05
Nodes (43): markAllRead, { notifications, unreadCount }, handleClick(), iconMap, markRead, navigate, NotificationItemProps, NotificationWatcher() (+35 more)
...
Nodes (33): { 
    ...
    setSelectedProjects,
    setSelectedTags
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, deleteProject (+25 more)

### Community 3 - "Audit & Activity Logging"
Cohesion: 0.11
Nodes (18): ColorIconPickerProps, cn(), result, SidebarBrandingProps, GripHandle, GripHandleProps, SidebarItemActions(), SidebarItemActionsProps (+10 more)
...
Cohesion: 0.15
Nodes (17): useToast(), useTaskDrawerActions(), UseTaskDrawerActionsProps, UseTaskDrawerActionsReturn, useTaskDrawerSync(), UseTaskDrawerSyncReturn, useAttachTag(), useCreateSubtask() (+9 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.12
Nodes (21): PRESET_COLORS, TaskDetailDrawer(), CreateProjectMutation, useProjectManagement(), UseProjectManagementReturn, useSubtaskManagement(), UseSubtaskManagementReturn, CreateTagMutation (+13 more)

### Community 8 - "API Documentation & Integration"
Cohesion: 0.09
Nodes (22): PRESET_ICONS, [color, setColor], COLORS, createProject, CreateProjectModalProps, [icon, setIcon], [lastOpen, setLastOpen], [name, setName] (+14 more)

### Community 9 - "Main Application Shell"
Cohesion: 0.09
Nodes (23): LoadingScreen(), ProtectedRoute(), ProtectedRouteProps, PublicRoute(), { token, loading }, { user, loading }, AuditLogsPage(), VerifyEmailPage() (+15 more)

### Community 10 - "Data Models & Entities"
Cohesion: 0.11
Nodes (13): categoryConfig, [pendingAction, setPendingAction], priorityConfig, [showAllSubtasks, setShowAllSubtasks], [showConfirm, setShowConfirm], TaskCardProps, { timeFormat }, SortMode (+5 more)

### Community 11 - "Linting Configuration"
Cohesion: 0.09
Nodes (21): { activeStatus, setActiveStatus }, [activeTab, setActiveTab], [confirmData, setConfirmData], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag (+13 more)
...
Cohesion: 0.12
Nodes (10): ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState, AuthProvider() (+2 more)
...
Cohesion: 0.11
Nodes (18): [confirmPassword, setConfirmPassword], confirmPasswordError, [email, setEmail], emailError, met, navigate, PASSWORD_RULES, [password, setPassword] (+10 more)
...
Cohesion: 0.15
Nodes (13): FilterContext, FilterContextType, useFilters(), PRIORITY_ORDER, SortMode, useTaskFilters(), { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId }, MobileNavProps (+5 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (17): [confirmPassword, setConfirmPassword], confirmPasswordError, [email, setEmail], emailError, navigate, [password, setPassword], passwordError, passwordStrength (+9 more)
...
Cohesion: 0.24
Nodes (14): handleSubmit(), AuthContext, AuthContextType, AuthUser, BackendErrorDetail, extractAccessToken(), normalizeAuthUser(), normalizeText() (+6 more)

### Community 25 - "Community 25"
Cohesion: 0.23
Nodes (15): Dashboard(), useAuth(), Group, Subtask, Tag, TagDistribution, Task, TaskStats (+7 more)

### Community 26 - "Community 26"
Cohesion: 0.19
Nodes (6): ConfirmationModalProps, [dontShowAgain, setDontShowAgain], DeleteConfirmationModalProps, AlertDialog(), AlertDialogCancel(), ConfirmationModalProps

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (14): actionsTrigger, deleteBtn, deleteButtons, DeleteConfirmationModalProps, deleteModalButton, editButtons, mockSetActiveSidebarFilter, mockSetActiveTagId (+6 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (7): [inputValue, setInputValue], [isFocused, setIsFocused], [isOpen, setIsOpen], [prevValue, setPrevValue], suggestions, { timeFormat }, TimePickerProps

### Community 29 - "Community 29"
Cohesion: 0.15
Nodes (9): useProjects(), useCreateTag(), useTags(), useUpdateTag(), { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps (+1 more)

### Community 30 - "Community 30"
Cohesion: 0.31
Nodes (12): Sidebar(), TopNav(), useCreateTask(), useStats(), useTasks(), useStats(), useTasks(), MainLayout() (+4 more)

### Community 31 - "Community 31"
Cohesion: 0.22
Nodes (9): useCreateProject(), useDeleteProject(), useReorderProjects(), useUpdateProject(), useSidebarActions(), useDeleteTag(), useReorderTags(), Project (+1 more)

### Community 32 - "Community 32"
Cohesion: 0.16
Nodes (13): formatFirstBackendError(), getAuthErrorMessage(), [email, setEmail], emailError, handleSubmit(), { login, loading }, { login, loading, error }, navigate (+5 more)
...
Cohesion: 0.23
Nodes (6): LogoutDialogProps, useTheme(), ThemeToggle(), TopNavProps, extraProps, isDisabled
...
Cohesion: 0.22
Nodes (7): Group, isLogoutRequest, mutatingMethods, statsApi, TagDistribution, TaskCreateData, TaskStats
...
Cohesion: 0.22
Nodes (9): handleSubmit(), handleConfirmAction(), handleConfirmDelete(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete() (+1 more)
...
Cohesion: 0.28
Nodes (6): SystemOverview(), StatsOverview, StatsOverview, TaskListProps, Card, Skeleton()
...
Cohesion: 0.29
Nodes (5): [email, setEmail], handleSubmit(), [isLoading, setIsLoading], [isSubmitted, setIsSubmitted], { toast }
...
Cohesion: 0.33
Nodes (4): sensors, subtaskIds, SubtaskSection(), SubtaskSectionProps
...
Cohesion: 0.4
Nodes (4): onDelete, onEdit, parentClick, user
...
Cohesion: 0.4
Nodes (5): RegisterForm(), validateEmail(), validatePassword(), validateUsername(), handleUpdatePassword()
...
Cohesion: 0.5
Nodes (3): SelectScrollDownButton, SelectScrollUpButton, SelectTrigger
...
## Knowledge Gaps
- **891 isolated node(s):** `LoginPage`, `RegisterPage`, `LandingPage`, `ForgotPasswordPage`, `ProfilePage` (+886 more)
...
- **Why does `cn()` connect `Audit & Activity Logging` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `API Documentation & Integration`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 26`, `Community 28`, `Community 29`, `Community 36`, `Community 40`, `Community 92`, `Community 106`, `Community 112`, `Community 118`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Theme Utilities` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Testing & Validation`, `API Documentation & Integration`, `Linting Configuration`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 40`, `Community 46`, `Community 103`, `Community 114`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 25` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Linting Configuration`, `Community 18`, `Community 21`, `Community 22`, `Community 24`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 40`, `Community 45`, `Community 105`, `Community 114`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
