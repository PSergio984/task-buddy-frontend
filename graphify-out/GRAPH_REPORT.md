...
## Corpus Check
- 81 files · ~120,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 817 nodes · 1272 edges · 68 communities (67 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `515d8fbd`
...
Cohesion: 0.06
Nodes (61): Dashboard(), NewTaskModal(), { 
    activeSidebarFilter, 
    setActiveSidebarFilter,
    activeTagId,
    setActiveTagId 
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, { groups } (+53 more)

### Community 1 - "Core UI Components"
Cohesion: 0.06
Nodes (50): [activeTab, setActiveTab], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask (+42 more)
...
Cohesion: 0.1
Nodes (14): [category, setCategory], { data: groups = [] }, { data: projects = [] }, [description, setDescription], [dueDate, setDueDate], [groupId, setGroupId], { groups }, NewTaskModalProps (+6 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.13
Nodes (17): api, tasksApi, {
    data: task,
    isLoading,
    error,
...
Cohesion: 0.12
Nodes (15): { data: projects = [] }, deleteTask, [description, setDescription], [isEditingTitle, setIsEditingTitle], priorityColors, TaskDetailDrawerProps, [title, setTitle], updateTask (+7 more)
...
Cohesion: 0.15
Nodes (9): [color, setColor], COLORS, createProject, CreateProjectModalProps, [name, setName], { toast }, useCreateProject(), useProjects() (+1 more)
...
Cohesion: 0.17
Nodes (8): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, LogoutDialogProps, useCreateGroup()
...
## Knowledge Gaps
- **458 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `EXCLUDED_ACTIONS`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]` (+453 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `State Management & Actions`, `Theme Utilities`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Community 16`, `Community 17`, `Community 22`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 19` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Linting Configuration`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `Testing & Validation`, `Data Models & Entities`, `Linting Configuration`, `Playwright Testing Config`, `Community 16`, `Community 17`, `Community 21`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
