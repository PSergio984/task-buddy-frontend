...
## Corpus Check
- 159 files · ~174,652 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1541 nodes · 2331 edges · 131 communities (125 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c820c9f6`
...
2. `useAuth()` - 47 edges
3. `cn()` - 43 edges
4. `useTaskDrawerState()` - 21 edges
5. `toast()` - 20 edges
6. `Task` - 16 edges
7. `Task-Buddy Frontend` - 15 edges
8. `TasksPage()` - 14 edges
9. `sanitizePassword()` - 13 edges
10. `useFilters()` - 11 edges
...
Nodes (34): { 
    ...
    setSelectedProjects,
    setSelectedTags
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, deleteProject (+26 more)

### Community 2 - "User Navigation & Theme"
Cohesion: 0.13
Nodes (25): useToast(), useCreateProject(), useProjects(), useCreateTag(), useDeleteTag(), useTags(), useUpdateTag(), areSubtasksDirty() (+17 more)

### Community 3 - "Audit & Activity Logging"
Cohesion: 0.14
Nodes (30): Dashboard(), NewTaskModal(), Sidebar(), TaskDetailDrawer(), TopNav(), TopNavProps, useAuth(), Group (+22 more)
...
Cohesion: 0.08
Nodes (25): PRESET_COLORS, PRESET_ICONS, [color, setColor], COLORS, createProject, CreateProjectModalProps, handleSubmit(), [icon, setIcon] (+17 more)

### Community 6 - "Theme Utilities"
Cohesion: 0.08
Nodes (28): { activeStatus, setActiveStatus }, [activeTab, setActiveTab], [confirmData, setConfirmData], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag (+20 more)
...
Cohesion: 0.12
Nodes (12): ColorIconPickerProps, { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps, { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId }, MobileNavProps, tabs (+4 more)

### Community 12 - "Playwright Testing Config"
Cohesion: 0.1
Nodes (14): SettingsContext, SettingsContextType, SettingsProvider(), { result }, TimeFormat, useSettings(), [inputValue, setInputValue], [isFocused, setIsFocused] (+6 more)

### Community 13 - "Tailwind CSS Styling"
Cohesion: 0.11
Nodes (15): DirtySections, [hours, minutes], MetaSidebar(), MetaSidebarProps, newDate, [popoverOpen, setPopoverOpen], PRIORITY_STYLES, quickDates (+7 more)

### Community 14 - "Build & Vite Configuration"
Cohesion: 0.14
Nodes (16): met, PASSWORD_RULES, PasswordStrengthMeterProps, { score, label }, AuthContext, AuthContextType, AuthUser, BackendErrorDetail (+8 more)
...
Cohesion: 0.1
Nodes (15): BeforeInstallPromptEvent, [deferredPrompt, setDeferredPrompt], isAndroidApp, [isIOS], [isIOS, setIsIOS], [isStandalone], [isStandalone, setIsStandalone], [isVisible, setIsVisible] (+7 more)
...
Cohesion: 0.13
Nodes (16): TaskPriority, tasksApi, {
    data: task,
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate, queryClient (+8 more)
...
Cohesion: 0.17
Nodes (12): FilterContext, FilterContextType, FilterProvider(), useFilters(), PRIORITY_ORDER, SortMode, useTaskFilters(), LayoutContext (+4 more)
...
Cohesion: 0.2
Nodes (7): SidebarItemActions(), SidebarItemActionsProps, onDelete, onEdit, parentClick, user, DropdownMenu()

### Community 38 - "Community 38"
Cohesion: 0.18
Nodes (9): Group, isLogoutRequest, mutatingMethods, statsApi, Subtask, subtasksApi, TagDistribution, TaskCreateData (+1 more)
...
Cohesion: 0.22
Nodes (5): useDeleteProject(), useReorderProjects(), useUpdateProject(), Project, projectsApi

### Community 61 - "Community 61"
Cohesion: 0.22
Nodes (9): handleConfirmAction(), handleConfirmDelete(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete(), genId() (+1 more)
...
Cohesion: 0.29
Nodes (8): handleSubmit(), navigate, sanitizeEmail(), sanitizeUsername(), getErrorMessage(), handleUpdateUsername(), handleSubmit(), navigate
...
Cohesion: 0.38
Nodes (5): SortMode, TasksHeaderProps, Badge(), BadgeProps, badgeVariants
...
## Knowledge Gaps
- **872 isolated node(s):** `LoginPage`, `RegisterPage`, `LandingPage`, `ForgotPasswordPage`, `ProfilePage` (+867 more)
...
- **Why does `useAuth()` connect `Audit & Activity Logging` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Community 101`, `Theme Utilities`, `Community 38`, `API Documentation & Integration`, `Data Models & Entities`, `Build & Vite Configuration`, `Project Documentation`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 60`, `Community 29`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `cn()` connect `Linting Configuration` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Main Application Shell`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 26`, `Community 30`, `Community 31`, `Community 37`, `Community 99`, `Community 103`, `Community 115`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `useToast()` connect `User Navigation & Theme` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Main Application Shell`, `Build & Vite Configuration`, `Project Documentation`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 60`, `Community 29`?**
