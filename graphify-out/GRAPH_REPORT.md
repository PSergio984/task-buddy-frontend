# Graph Report - task-buddy-frontend  (2026-05-18)

## Corpus Check
- 150 files · ~159,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1688 nodes · 2657 edges · 140 communities (135 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec113639`
...
Cohesion: 0.06
Nodes (35): [confirmationInput, setConfirmationInput], DeleteProjectModalProps, [deleteTasks, setDeleteTasks], [lastOpen, setLastOpen], [shake, setShake], animations, { 
    activeSidebarFilter, 
    activeStatus, 
    setActiveStatus, 
    activeTagId,
  }, [confirmData, setConfirmData] (+27 more)
...
Cohesion: 0.06
Nodes (28): TaskCard(), SettingsContext, SettingsContextType, SettingsProvider(), { result }, TimeFormat, useSettings(), displayTime (+20 more)
...
Cohesion: 0.07
Nodes (28): sanitizeUsername(), [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], { data: vapidData }, { data: vapidData, isLoading: isLoadingVapid }, getErrorMessage(), handleTogglePush(), handleUpdateUsername() (+20 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.16
Nodes (19): useSubtaskManagement(), UseSubtaskManagementReturn, useTaskDirtyState(), UseTaskDirtyStateProps, useTaskDrawerActions(), UseTaskDrawerActionsProps, UseTaskDrawerActionsReturn, areSubtasksDirty() (+11 more)

### Community 8 - "API Documentation & Integration"
Cohesion: 0.09
Nodes (19): PRESET_COLORS, [color, setColor], COLORS, createProject, CreateProjectModalProps, handleSubmit(), [icon, setIcon], [lastOpen, setLastOpen] (+11 more)
...
Cohesion: 0.13
Nodes (11): ColorIconPickerProps, { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps, cn(), result, SidebarBrandingProps (+3 more)
...
Cohesion: 0.12
Nodes (18): SystemOverview(), StatsOverview, tasksApi, {
    data: task,
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate (+10 more)

### Community 16 - "Community 16"
Cohesion: 0.11
Nodes (12): ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState, useTheme() (+4 more)
...
Cohesion: 0.11
Nodes (12): categoryConfig, [pendingAction, setPendingAction], priorityConfig, [showAllSubtasks, setShowAllSubtasks], [showConfirm, setShowConfirm], TaskCardProps, { timeFormat }, SortMode (+4 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (17): LogoutDialogProps, BeforeInstallPromptEvent, [deferredPrompt, setDeferredPrompt], handler, isAndroidApp, [isIOS], [isIOS, setIsIOS], [isStandalone] (+9 more)
...
Cohesion: 0.15
Nodes (15): markAllRead, { notifications, unreadCount }, handleClick(), iconMap, markRead, navigate, NotificationItemProps, NotificationWatcher() (+7 more)
...
Cohesion: 0.14
Nodes (13): FilterContext, FilterContextType, FilterProvider(), useFilters(), PRIORITY_ORDER, SortMode, useTaskFilters(), { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId } (+5 more)

### Community 29 - "Community 29"
Cohesion: 0.19
Nodes (16): Dashboard(), useAuth(), Group, StatsOverview, Subtask, Tag, TagDistribution, TaskStats (+8 more)
...
Cohesion: 0.13
Nodes (13): CreateTagMutation, useTagManagement(), UseTagManagementReturn, Group, isLogoutRequest, mutatingMethods, notificationsApi, statsApi (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.22
Nodes (13): AuthContext, AuthContextType, AuthUser, BackendErrorDetail, extractAccessToken(), formatFirstBackendError(), getAuthErrorMessage(), getPasswordStrength() (+5 more)
...
Cohesion: 0.21
Nodes (11): useDeleteProject(), useReorderProjects(), useSidebarActions(), useDeleteTag(), useReorderTags(), useTags(), useUpdateTag(), stores (+3 more)
...
Cohesion: 0.18
Nodes (10): PRESET_ICONS, [color, setColor], createTag, CreateTagModalProps, handleSubmit(), [icon, setIcon], [lastOpen, setLastOpen], [name, setName] (+2 more)
...
## Knowledge Gaps
- **957 isolated node(s):** `LoginPage`, `RegisterPage`, `LandingPage`, `ForgotPasswordPage`, `ProfilePage` (+952 more)
...
- **Why does `useAuth()` connect `Community 29` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Linting Configuration`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Community 21`, `Community 24`, `Community 25`, `Community 33`, `Community 35`, `Community 37`, `Community 40`, `Community 107`, `Community 111`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Tailwind CSS Styling` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Data Models & Entities`, `Linting Configuration`, `Project Documentation`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 35`, `Community 37`, `Community 40`, `Community 47`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `cn()` connect `Playwright Testing Config` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Theme Utilities`, `Main Application Shell`, `Data Models & Entities`, `Project Documentation`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 31`, `Community 34`, `Community 41`, `Community 107`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `LoginPage`, `RegisterPage`, `LandingPage` to the rest of the system?**
