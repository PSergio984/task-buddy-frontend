...
## Corpus Check
- 76 files · ~115,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 743 nodes · 1169 edges · 64 communities (63 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `645e6975`
...
Cohesion: 0.05
Nodes (82): [activeTab, setActiveTab], Dashboard(), DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete (+74 more)

### Community 1 - "Core UI Components"
Cohesion: 0.05
Nodes (37): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, [color, setColor], COLORS (+29 more)
...
Cohesion: 0.22
Nodes (6): cn(), result, InputProps, labelVariants, Skeleton(), TextareaProps
...
Cohesion: 0.22
Nodes (6): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, Card, DropdownMenu()
...
## Knowledge Gaps
- **409 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+404 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `State Management & Actions`, `Testing & Validation`, `API Documentation & Integration`, `Linting Configuration`, `Project Documentation`, `Community 17`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Project Documentation`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `cn()` connect `Data Models & Entities` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `Theme Utilities`, `API Documentation & Integration`, `Linting Configuration`, `Playwright Testing Config`, `Community 49`, `Community 21`?**
