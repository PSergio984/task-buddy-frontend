...
## Corpus Check
- 83 files · ~123,551 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 869 nodes · 1355 edges · 74 communities (72 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52fd57cb`
...
Cohesion: 0.11
Nodes (20): [activeTab, setActiveTab], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask (+12 more)
...
Cohesion: 0.12
Nodes (19): sanitizePassword(), validatePassword(), [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], handleUpdatePassword(), [isInitialized, setIsInitialized], [isUpdatingPassword, setIsUpdatingPassword], [isUpdatingUsername, setIsUpdatingUsername] (+11 more)
...
Cohesion: 0.14
Nodes (16): TaskPriority, {
    data: task,
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate, queryClient, { toast } (+8 more)

### Community 13 - "Tailwind CSS Styling"
Cohesion: 0.14
Nodes (15): useAttachTag(), useCreateSubtask(), useCreateTag(), useDeleteSubtask(), useDeleteTask(), useDetachTag(), useUpdateSubtask(), Subtask (+7 more)
...
Cohesion: 0.2
Nodes (5): LogoutDialogProps, containerVariants, itemVariants, extraProps, isDisabled

### Community 27 - "Community 27"
Cohesion: 0.22
Nodes (6): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, Task, DropdownMenu()
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Data Models & Entities`, `Tailwind CSS Styling`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `Main Application Shell`, `Data Models & Entities`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Community 17`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `Project Documentation` to `Authentication & Authorization`, `Core UI Components`, `Community 26`, `Task Management Forms`, `Audit & Activity Logging`, `Theme Utilities`, `API Documentation & Integration`, `Community 59`, `Main Application Shell`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Community 55`, `Community 58`, `Community 27`?**
