...
## Corpus Check
- 100 files · ~131,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1043 nodes · 1655 edges · 85 communities (81 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6aa36909`
...
Cohesion: 0.06
Nodes (35): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, { 
    activeSidebarFilter, 
...
Cohesion: 0.08
Nodes (25): SettingsContext, SettingsContextType, SettingsProvider(), { result }, TimeFormat, [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], getErrorMessage() (+17 more)
...
Cohesion: 0.12
Nodes (16): Group, isLogoutRequest, Project, statsApi, StatsOverview, subtasksApi, Tag, TagDistribution (+8 more)
...
Cohesion: 0.15
Nodes (12): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, [color, setColor], createTag, CreateTagModalProps, handleSubmit(), [icon, setIcon] (+4 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Theme Utilities`, `API Documentation & Integration`, `Linting Configuration`, `Playwright Testing Config`, `Community 17`, `Community 19`, `Community 24`, `Community 28`, `Community 62`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 21` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Community 68`, `Theme Utilities`, `Main Application Shell`, `Build & Vite Configuration`, `Project Documentation`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 29`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Theme Utilities`, `API Documentation & Integration`, `Linting Configuration`, `Playwright Testing Config`, `Build & Vite Configuration`, `Community 17`, `Community 19`, `Community 24`?**
