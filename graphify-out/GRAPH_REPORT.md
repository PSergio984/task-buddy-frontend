...
## Corpus Check
- 159 files · ~174,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1539 nodes · 2329 edges · 133 communities (128 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9d49ddb`
...
Cohesion: 0.05
Nodes (80): { activeStatus, setActiveStatus }, [activeTab, setActiveTab], [confirmData, setConfirmData], Dashboard(), DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask (+72 more)
...
Cohesion: 0.08
Nodes (23): actionsTrigger, deleteBtn, deleteButtons, DeleteConfirmationModalProps, deleteModalButton, editButtons, mockSetActiveSidebarFilter, mockSetActiveTagId (+15 more)

### Community 6 - "Theme Utilities"
Cohesion: 0.2
Nodes (25): useToast(), useCreateProject(), useProjects(), useCreateTag(), useTags(), areSubtasksDirty(), areTagsDirty(), useTaskDrawerState() (+17 more)
...
Cohesion: 0.1
Nodes (10): Group, isLogoutRequest, mutatingMethods, statsApi, subtasksApi, TagDistribution, tagsApi, TaskCreateData (+2 more)
...
Cohesion: 0.11
Nodes (15): [color, setColor], COLORS, createProject, CreateProjectModalProps, [icon, setIcon], [lastOpen, setLastOpen], [name, setName], { toast } (+7 more)

### Community 13 - "Tailwind CSS Styling"
Cohesion: 0.11
Nodes (20): RegisterForm(), validateEmail(), validatePasswordConfirmation(), validateUsername(), [confirmPassword, setConfirmPassword], confirmPasswordError, [email, setEmail], emailError (+12 more)

### Community 14 - "Build & Vite Configuration"
Cohesion: 0.14
Nodes (9): LogoutDialogProps, { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps, cn(), result, SortableSidebarItemProps (+1 more)
...
Cohesion: 0.12
Nodes (16): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, [color, setColor], createTag, CreateTagModalProps, handleSubmit(), [icon, setIcon] (+8 more)
...
Nodes (15): {
    ...
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate, queryClient, { toast }, toggleMutation (+7 more)

### Community 19 - "Community 19"
Cohesion: 0.14
Nodes (15): Action, ActionType, actionTypes, addToRemoveQueue(), dispatch(), listeners, memoryState, reducer() (+7 more)
...
Cohesion: 0.15
Nodes (13): sanitizeEmail(), [email, setEmail], emailError, handleSubmit(), { login, loading }, { login, loading, error }, navigate, [password, setPassword] (+5 more)
...
Cohesion: 0.18
Nodes (8): met, PASSWORD_RULES, PasswordStrengthMeterProps, { score, label }, getPasswordStrength(), normalizeText(), ResetPasswordPage(), InputProps
...
Cohesion: 0.2
Nodes (5): containerVariants, itemVariants, ActionFooterProps, extraProps, isDisabled

### Community 42 - "Community 42"
Cohesion: 0.2
Nodes (10): handleSubmit(), handleConfirmAction(), handleConfirmDelete(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete() (+2 more)
...
Cohesion: 0.29
Nodes (5): Subtask, sensors, subtaskIds, SubtaskSection(), SubtaskSectionProps
...
## Knowledge Gaps
- **870 isolated node(s):** `LoginPage`, `RegisterPage`, `LandingPage`, `ForgotPasswordPage`, `ProfilePage` (+865 more)
...
- **Why does `useToast()` connect `Theme Utilities` to `Authentication & Authorization`, `Community 32`, `User Navigation & Theme`, `Core UI Components`, `Community 100`, `Testing & Validation`, `API Documentation & Integration`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Project Documentation`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `cn()` connect `Build & Vite Configuration` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Project Documentation`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 32`, `Community 36`, `Community 41`, `Community 99`, `Community 101`, `Community 109`, `Community 113`, `Community 118`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Authentication & Authorization` to `User Navigation & Theme`, `Audit & Activity Logging`, `Community 38`, `Community 103`, `API Documentation & Integration`, `Testing & Validation`, `Theme Utilities`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Project Documentation`, `Community 16`, `Community 21`, `Community 25`, `Community 30`?**
