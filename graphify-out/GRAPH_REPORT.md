...
## Corpus Check
- 84 files · ~124,537 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 893 nodes · 1404 edges · 74 communities (72 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `07a697c7`
...
Cohesion: 0.05
Nodes (78): Dashboard(), NewTaskModal(), { 
    activeSidebarFilter, 
    setActiveSidebarFilter,
    activeTagId,
    setActiveTagId 
  }, categories, { data: groups = [] }, { data: projects = [] }, { data: tags = [] }, { groups } (+70 more)

### Community 1 - "Core UI Components"
Cohesion: 0.04
Nodes (44): attachTag, createSubtask, createTag, createTask, { data: allTags = [] }, { data: fetchedTask }, { data: projects = [] }, [deleteSnapshot, setDeleteSnapshot] (+36 more)
...
Cohesion: 0.1
Nodes (22): [activeTab, setActiveTab], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask (+14 more)
...
Cohesion: 0.15
Nodes (18): useFilters(), useCreateProject(), useProjects(), useCreateTag(), useDeleteSubtask(), useDeleteTask(), useDetachTag(), useTasks() (+10 more)
...
Cohesion: 0.17
Nodes (10): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, cn(), result, SelectScrollDownButton, SelectScrollUpButton, SelectTrigger (+2 more)
...
Cohesion: 0.13
Nodes (13): useTags(), api, Group, isLogoutRequest, Project, projectsApi, statsApi, Tag (+5 more)
...
Cohesion: 0.17
Nodes (9): [color, setColor], COLORS, createProject, CreateProjectModalProps, handleSubmit(), [name, setName], { toast }, InputProps (+1 more)
...
## Knowledge Gaps
- **509 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `isUncompleted`, `isTagAttached`, `isTagDetached` (+504 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `User Navigation & Theme`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Project Documentation`, `Community 16`, `Community 17`, `Community 18`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `cn()` connect `Linting Configuration` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Community 35`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `Playwright Testing Config`, `Tailwind CSS Styling`, `Community 54`, `Community 22`, `Community 25`, `Community 58`, `Community 59`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Tailwind CSS Styling`, `Community 16`, `Community 18`, `Community 22`?**
