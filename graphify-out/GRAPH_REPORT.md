...
## Corpus Check
- 77 files · ~118,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 719 nodes · 1127 edges · 58 communities (57 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `878e569c`
...
Cohesion: 0.05
Nodes (34): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, LogoutDialogProps, [category, setCategory] (+26 more)

### Community 2 - "User Navigation & Theme"
Cohesion: 0.05
Nodes (39): AuditEntry, AuditTrailProps, controller, [currentLimit, setCurrentLimit], [error, setError], fetchAuditLog, filteredLogs, [loading, setLoading] (+31 more)
...
Nodes (34): { 
    ...
    activeTagId,
    setActiveTagId 
  }, categories, { data: groups = [] }, { data: tags = [] }, { groups }, handleLogout(), [isCreateGroupModalOpen, setIsCreateGroupModalOpen], [isLogoutDialogOpen, setIsLogoutDialogOpen] (+26 more)
...
## Knowledge Gaps
- **395 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+390 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Theme Utilities`, `Testing & Validation`, `Linting Configuration`, `Tailwind CSS Styling`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `State Management & Actions`, `Theme Utilities`, `Testing & Validation`, `Linting Configuration`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `cn()` connect `Core UI Components` to `Authentication & Authorization`, `User Navigation & Theme`, `Audit & Activity Logging`, `State Management & Actions`?**
