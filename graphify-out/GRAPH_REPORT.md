...
## Corpus Check
- 66 files · ~120,966 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 579 nodes · 848 edges · 56 communities (55 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76b68b48`
...
Cohesion: 0.09
Nodes (45): Dashboard(), DashboardProps, [category, setCategory], [description, setDescription], [dueDate, setDueDate], [groupId, setGroupId], { groups }, NewTaskModal() (+37 more)
...
Cohesion: 0.12
Nodes (15): [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], [isInitialized, setIsInitialized], [isUpdatingPassword, setIsUpdatingPassword], [isUpdatingUsername, setIsUpdatingUsername], met, navigate, [newPassword, setNewPassword] (+7 more)
...
Cohesion: 0.16
Nodes (12): categories, { groups }, handleLogout(), [isLogoutDialogOpen, setIsLogoutDialogOpen], location, navigate, navLinks, SidebarProps (+4 more)

### Community 10 - "Data Models & Entities"
Cohesion: 0.21
Nodes (7): SystemOverview(), cn(), InputProps, labelVariants, SelectScrollDownButton, SelectScrollUpButton, SelectTrigger
...
Cohesion: 0.5
Nodes (5): handleSubmit(), navigate, sanitizePassword(), validatePassword(), handleUpdatePassword()
...
## Knowledge Gaps
- **322 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+317 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Playwright Testing Config`, `Tailwind CSS Styling`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `Data Models & Entities` to `Authentication & Authorization`, `User Navigation & Theme`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Tailwind CSS Styling`, `Community 17`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Task-Buddy Frontend` connect `Build & Vite Configuration` to `Community 42`, `Community 43`, `Community 45`, `Community 18`, `Community 24`?**
