...
Cohesion: 0.11
Nodes (21): [activeTab, setActiveTab], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask (+13 more)
...
Cohesion: 0.15
Nodes (11): api, Group, isLogoutRequest, Project, statsApi, Tag, TagDistribution, tagsApi (+3 more)
...
Cohesion: 0.25
Nodes (5): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, DropdownMenu()
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `Main Application Shell`, `Linting Configuration`, `Project Documentation`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `Testing & Validation`, `Main Application Shell`, `Linting Configuration`, `Playwright Testing Config`, `Project Documentation`, `Community 17`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `Build & Vite Configuration` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `Community 37`, `Theme Utilities`, `API Documentation & Integration`, `Linting Configuration`, `Playwright Testing Config`, `Project Documentation`, `Community 55`, `Community 57`, `Community 58`, `Community 27`?**
