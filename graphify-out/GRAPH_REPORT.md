...
## Corpus Check
- 106 files · ~135,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1106 nodes · 1765 edges · 88 communities (85 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5705f35a`
...
Cohesion: 0.21
Nodes (21): TaskDetailDrawer(), useFilters(), useTags(), useTaskDrawerState(), UseTaskDrawerStateProps, useAttachTag(), useCreateSubtask(), useCreateTag() (+13 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.11
Nodes (18): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, [color, setColor], COLORS, createProject, CreateProjectModalProps, [icon, setIcon] (+10 more)
...
Cohesion: 0.18
Nodes (7): { activeSidebarFilter, setActiveSidebarFilter, setActiveTagId }, MobileNavProps, tabs, cn(), result, labelVariants, TextareaProps

### Community 21 - "Community 21"
Cohesion: 0.21
Nodes (13): AuthContext, AuthContextType, api, AuthUser, BackendErrorDetail, extractAccessToken(), formatFirstBackendError(), getAuthErrorMessage() (+5 more)
...
Cohesion: 0.15
Nodes (6): LogoutDialogProps, ActionFooterProps, AlertDialog(), AlertDialogCancel(), extraProps, isDisabled
...
Cohesion: 0.17
Nodes (7): useCreateProject(), useProjects(), { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps, projectsApi
...
- **Why does `cn()` connect `Community 20` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Community 68`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Tailwind CSS Styling`, `Project Documentation`, `Community 18`, `Community 19`, `Community 22`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `Audit & Activity Logging`, `Community 69`, `Theme Utilities`, `API Documentation & Integration`, `Data Models & Entities`, `Build & Vite Configuration`, `Community 18`, `Community 21`, `Community 23`, `Community 27`, `Community 63`, `Community 31`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Data Models & Entities`, `Build & Vite Configuration`, `Community 21`, `Community 23`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
