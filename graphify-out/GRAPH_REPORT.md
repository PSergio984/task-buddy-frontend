...
## Summary
- 1541 nodes · 2331 edges · 132 communities (126 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0eb07316`
...
Cohesion: 0.14
Nodes (31): Dashboard(), NewTaskModal(), Sidebar(), TaskDetailDrawer(), TopNav(), TopNavProps, useAuth(), Group (+23 more)
...
Cohesion: 0.08
Nodes (25): { activeStatus, setActiveStatus }, [activeTab, setActiveTab], [confirmData, setConfirmData], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag (+17 more)
...
Cohesion: 0.1
Nodes (21): LoadingScreen(), ProtectedRoute(), ProtectedRouteProps, PublicRoute(), { token, loading }, { user, loading }, VerifyEmailPage(), App() (+13 more)
...
Cohesion: 0.16
Nodes (15): TaskCard(), FilterContext, FilterContextType, FilterProvider(), useFilters(), PRIORITY_ORDER, SortMode, useTaskFilters() (+7 more)
...
Cohesion: 0.12
Nodes (10): categoryConfig, [pendingAction, setPendingAction], priorityConfig, [showAllSubtasks, setShowAllSubtasks], [showConfirm, setShowConfirm], TaskCardProps, { timeFormat }, Badge() (+2 more)
...
Cohesion: 0.16
Nodes (9): SidebarItemActions(), SidebarItemActionsProps, onDelete, onEdit, parentClick, user, SortMode, TasksHeaderProps (+1 more)
...
Cohesion: 0.4
Nodes (5): sanitizeUsername(), getErrorMessage(), handleUpdateUsername(), handleSubmit(), navigate
...
- **Why does `useAuth()` connect `Audit & Activity Logging` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Community 101`, `Community 38`, `Testing & Validation`, `API Documentation & Integration`, `Linting Configuration`, `Tailwind CSS Styling`, `Community 18`, `Community 19`, `Community 22`, `Community 27`, `Community 60`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `cn()` connect `Data Models & Entities` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `Task Management Forms`, `State Management & Actions`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Playwright Testing Config`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 32`, `Community 62`, `Community 103`, `Community 117`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `useToast()` connect `User Navigation & Theme` to `Authentication & Authorization`, `Core UI Components`, `Audit & Activity Logging`, `State Management & Actions`, `Testing & Validation`, `API Documentation & Integration`, `Main Application Shell`, `Tailwind CSS Styling`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 27`, `Community 60`, `Community 29`, `Community 31`?**
