# Graph Report - task-buddy-frontend  (2026-05-09)

## Corpus Check
- 77 files · ~118,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 716 nodes · 1124 edges · 64 communities (63 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ba59b57`
...
6. `TasksPage()` - 11 edges
7. `Task-Buddy API Integration Guide` - 11 edges
8. `useTasks()` - 11 edges
9. `Core Sections (Required)` - 10 edges
10. `Dashboard()` - 10 edges
...
Cohesion: 0.1
Nodes (41): Dashboard(), NewTaskModal(), Sidebar(), TopNav(), TopNavProps, useAuth(), FilterContext, FilterContextType (+33 more)

### Community 1 - "Core UI Components"
Cohesion: 0.07
Nodes (40): DashboardProps, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete, handleToggleSubtask, { logout }, { mutateAsync: deleteSubtask } (+32 more)

### Community 2 - "User Navigation & Theme"
Cohesion: 0.07
Nodes (26): [color, setColor], COLORS, createGroup, CreateGroupModalProps, [name, setName], { toast }, { 
    activeSidebarFilter, 
...
Cohesion: 0.11
Nodes (17): [confirmPassword, setConfirmPassword], [currentPassword, setCurrentPassword], handleUpdateUsername(), [isInitialized, setIsInitialized], [isUpdatingPassword, setIsUpdatingPassword], [isUpdatingUsername, setIsUpdatingUsername], met, navigate (+9 more)
...
Cohesion: 0.12
Nodes (16): [confirmPassword, setConfirmPassword], confirmPasswordError, [email, setEmail], emailError, handleSubmit(), navigate, [password, setPassword], passwordError (+8 more)

### Community 9 - "Main Application Shell"
Cohesion: 0.12
Nodes (13): [category, setCategory], { data: groups = [] }, [description, setDescription], [dueDate, setDueDate], [groupId, setGroupId], { groups }, NewTaskModalProps, [priority, setPriority] (+5 more)
...
Nodes (14): {
    ...
    isLoading,
    error,
  }, deleteMutation, { id }, [isDeleting, setIsDeleting], navigate, queryClient, { toast }, toggleMutation (+6 more)

### Community 11 - "Linting Configuration"
Cohesion: 0.12
Nodes (14): AuditEntry, AuditTrailProps, controller, [currentLimit, setCurrentLimit], [error, setError], fetchAuditLog, filteredLogs, [loading, setLoading] (+6 more)
...
Cohesion: 0.23
Nodes (6): cn(), Badge(), BadgeProps, badgeVariants, InputProps, labelVariants
...
Cohesion: 0.22
Nodes (6): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, CardContent, DropdownMenu()
...
## Knowledge Gaps
- **393 isolated node(s):** `AuditEntry`, `AuditTrailProps`, `[logs, setLogs]`, `[currentLimit, setCurrentLimit]`, `[loading, setLoading]` (+388 more)
...
- **Why does `useAuth()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Linting Configuration`, `Playwright Testing Config`, `Community 45`, `Community 16`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Authentication & Authorization` to `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `State Management & Actions`, `Theme Utilities`, `API Documentation & Integration`, `Data Models & Entities`, `Community 45`, `Community 16`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `cn()` connect `Tailwind CSS Styling` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Task Management Forms`, `Theme Utilities`, `Main Application Shell`, `Data Models & Entities`, `Linting Configuration`, `Community 17`, `Community 21`?**
