# Graph Report - task-buddy-frontend  (2026-05-14)

## Corpus Check
- 156 files · ~173,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1493 nodes · 2249 edges · 129 communities (123 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88188335`
...
- `handleConfirmAction()` --calls--> `toast()`  [EXTRACTED]
  src/components/dashboard.tsx → src/hooks/use-toast.ts
...
Cohesion: 0.06
Nodes (36): categoryConfig, priorityConfig, TaskCard(), TaskCardProps, SettingsContext, SettingsContextType, SettingsProvider(), { result } (+28 more)
...
Cohesion: 0.07
Nodes (30): handleSubmit(), handleConfirmAction(), handleConfirmDelete(), handleAddSubtask(), handleAttachTag(), handleCreate(), handleCreateAndAttachTag(), handleDelete() (+22 more)
...
Cohesion: 0.09
Nodes (24): [activeTab, setActiveTab], [confirmData, setConfirmData], DashboardProps, filteredTasks, handleDelete, handleDeleteSubtask, handleDetachTag, handleToggleComplete (+16 more)

### Community 7 - "Testing & Validation"
Cohesion: 0.09
Nodes (23): ColorIconPickerProps, PRESET_COLORS, PRESET_ICONS, [color, setColor], COLORS, createProject, CreateProjectModalProps, [icon, setIcon] (+15 more)
...
Cohesion: 0.13
Nodes (10): { activeSidebarFilter, setActiveSidebarFilter, activeTagId, setActiveTagId }, { data: projects = [] }, { data: tags = [] }, MobileDrawerProps, cn(), result, SortableSidebarItemProps, InputProps (+2 more)

### Community 10 - "Data Models & Entities"
Cohesion: 0.09
Nodes (19): actionsTrigger, deleteBtn, deleteButtons, DeleteConfirmationModalProps, deleteModalButton, editButtons, mockSetActiveSidebarFilter, mockSetActiveTagId (+11 more)
...
Cohesion: 0.11
Nodes (11): SelectScrollDownButton, SelectScrollUpButton, SelectTrigger, [inputValue, setInputValue], [isFocused, setIsFocused], [isOpen, setIsOpen], [prevValue, setPrevValue], suggestions (+3 more)

### Community 19 - "Community 19"
Cohesion: 0.12
Nodes (14): TaskPriority, DirtySections, [hours, minutes], MetaSidebar(), MetaSidebarProps, newDate, [popoverOpen, setPopoverOpen], PRIORITY_STYLES (+6 more)

### Community 20 - "Community 20"
Cohesion: 0.12
Nodes (15): Group, isLogoutRequest, mutatingMethods, statsApi, Subtask, subtasksApi, Tag, TagDistribution (+7 more)

### Community 21 - "Community 21"
Cohesion: 0.36
Nodes (16): useToast(), useCreateProject(), useCreateTag(), useTaskDrawerState(), UseTaskDrawerStateProps, useAttachTag(), useCreateSubtask(), useCreateTag() (+8 more)
...
Cohesion: 0.23
Nodes (14): Dashboard(), useAuth(), Group, Subtask, Tag, TagDistribution, TaskStats, useDeleteSubtask() (+6 more)

### Community 25 - "Community 25"
Cohesion: 0.3
Nodes (12): NewTaskModal(), Sidebar(), Task, useCreateTask(), useStats(), useTasks(), useUpdateTask(), useStats() (+4 more)
...
Cohesion: 0.22
Nodes (12): AuthContext, AuthContextType, AuthUser, BackendErrorDetail, extractAccessToken(), formatFirstBackendError(), getAuthErrorMessage(), getPasswordStrength() (+4 more)
...
Cohesion: 0.21
Nodes (11): useFilters(), useDeleteTag(), useTags(), useUpdateTag(), useTasks(), tagsApi, LayoutContext, PRIORITY_ORDER (+3 more)
...
Cohesion: 0.23
Nodes (9): LoadingScreen(), ProtectedRoute(), ProtectedRouteProps, PublicRoute(), { token, loading }, { user, loading }, VerifyEmailPage(), { token } (+1 more)
...
Cohesion: 0.36
Nodes (5): useTheme(), ThemeToggle(), TopNav(), TopNavProps, AuditLogsPage()

### Community 96 - "Community 96"
Cohesion: 0.32
Nodes (8): handleSubmit(), navigate, sanitizePassword(), sanitizeUsername(), validatePassword(), getErrorMessage(), handleUpdatePassword(), handleUpdateUsername()
...
Cohesion: 0.33
Nodes (5): useDeleteProject(), useProjects(), useReorderProjects(), useUpdateProject(), projectsApi
...
## Knowledge Gaps
- **849 isolated node(s):** `{ user, loading }`, `persister`, `data`, `AuditTrailProps`, `{
...
- **Why does `useToast()` connect `Community 21` to `Community 32`, `Community 33`, `User Navigation & Theme`, `Audit & Activity Logging`, `Core UI Components`, `Authentication & Authorization`, `Theme Utilities`, `Community 102`, `API Documentation & Integration`, `Testing & Validation`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Project Documentation`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 95`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `cn()` connect `Main Application Shell` to `Authentication & Authorization`, `Core UI Components`, `User Navigation & Theme`, `Audit & Activity Logging`, `Task Management Forms`, `Theme Utilities`, `Testing & Validation`, `API Documentation & Integration`, `Data Models & Entities`, `Build & Vite Configuration`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 26`, `Community 29`, `Community 32`, `Community 41`, `Community 95`, `Community 113`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 24` to `Community 32`, `Community 33`, `User Navigation & Theme`, `Community 100`, `Community 37`, `Theme Utilities`, `Community 102`, `API Documentation & Integration`, `Task Management Forms`, `Tailwind CSS Styling`, `Build & Vite Configuration`, `Project Documentation`, `Community 21`, `Community 25`, `Community 27`, `Community 28`, `Community 95`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `{ user, loading }`, `persister`, `data` to the rest of the system?**
